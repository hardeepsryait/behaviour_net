...
The models are defined in `models.py`. The trained model will get stored in folder '/data/checkpoints/'. If you want to use the pre-trained model, it can be downloaded from http://people.uleth.ca/~luczak/BehavNet/g04-features.hdf5 to folder '/data/checkpoints/'.
